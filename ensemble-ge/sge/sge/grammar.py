...
class Grammar:
    ...
    def _recursive_mapping(self, mapping_rules, positions_to_map, current_sym, current_depth, output):
        ...
        if current_sym is not None and current_sym[1] == self.NT and 'RAND' in self.grammar[current_sym[0]][0][0][0]:
...
if __name__ == "__main__":
    random.seed(42)
    g = Grammar()
    g.set_path("grammars/auto_ml_CE.pybnf")
    g.set_min_init_tree_depth(9)
